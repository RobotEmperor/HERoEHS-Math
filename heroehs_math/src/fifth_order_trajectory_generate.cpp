    ...
    double initial_time_, double final_time_)
{
  if(current_time == 0)
  {
    ...
    //printf("2222222222222  %f :: %f \n", initial_velocity_, initial_acc_);
  ...
  if(current_time <= final_time_)
  {
    ...
    //current_acc = 2*a[2] + 6*a[3]*current_time + 12*a[4]*(pow(current_time,2)) + 20*a[5]*(pow(current_time,3));
    //printf("11111111111  %f :: %f \n", current_velocity, current_acc);
